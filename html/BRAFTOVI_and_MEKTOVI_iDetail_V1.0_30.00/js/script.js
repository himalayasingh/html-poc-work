...
$(document).ready(function() {
	if(localStorage.tab != 1 || localStorage.tab != 2 || localStorage.tab != 3){
	...
	if (localStorage.tab == 1) {
		...
		localStorage.tab = 0;
		$("#page4").show();
        $("#page1,#page3,#page2").hide();
		testScroll.scrollTo(0,-4662,0);
		if(tab4track == "True")	{ 
					trackAction('tracking_element_id4');
					tab1track = "True";                                
					tab2track = "True";                                
					tab3track = "True";                                
					tab4track = "False";  
	...
	$('.page1tab1').bind('tap', function() {
        $("#page11").show();
        $("#page12").hide();
    });
	$('.page1tab2').bind('tap', function() {
        $("#page12").show();
        $("#page11").hide();
    });
	...
	/* page2 popup start */
		$('.SD_DCR').bind('tap', function() {
			$("#page3_popup").show();
			$("#global_pops").addClass("noLink");		
		});
	
		$('#page3_popup_close').bind('tap', function() {
			$("#page3_popup").hide();
