...
$(document).ready(function() {
	...
	/* isi popup end */
		...
		$('.page1_popup2_btn').bind('tap', function() {
			$("#page1_popup2").show();
			$("#global_pops").addClass("noLink");		
		});
	
		$('#page1_popup2_close').bind('tap', function() {
			$("#page1_popup2").hide();
			$("#global_pops").removeClass("noLink");
		});
		$('.page1_popup3_btn').bind('tap', function() {
			$("#page1_popup3").show();
			$("#global_pops").addClass("noLink");		
		});
	
		$('#page1_popup3_close').bind('tap', function() {
			$("#page1_popup3").hide();
			$("#global_pops").removeClass("noLink");
		});
	...
	/* Menu popup end */		
		...
		$('.braftovi_pi,.popup_braf_pi,.braftovi_ssi_pi,.braftovi_ssi_pi1').bind('tap', function() {
			location = "pdf/Braftovi_PI.pdf";
		});

		$('.mektovi_pi,.popup_mekto_pi,.mektovi_ssi_pi').bind('tap', function() {
