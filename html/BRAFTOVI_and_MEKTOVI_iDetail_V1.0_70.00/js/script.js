...
$(document).ready(function() {
	...
	/* Linking Starts */
		...
		$('.link00_00,.slide1,.nccn_btn').bind('tap', function() {
		...
		$('.link30_00,.slide4,.pfs_btn,.link30_00_title').bind('tap', function() {
			com.veeva.clm.gotoSlide("BRAFTOVI_and_MEKTOVI_iDetail_V1.0_30.00.zip");	
		});
		$('.link30_10,.os_btn,.os_page_btn').bind('tap', function() {
			localStorage.tab = 1;
			com.veeva.clm.gotoSlide("BRAFTOVI_and_MEKTOVI_iDetail_V1.0_30.00.zip");	
		});
		...
		$('.link40_00,.slide5,.safety_btn,.link40_00_title').bind('tap', function() {
