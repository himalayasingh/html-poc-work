...
//	}
	...
	testScroll1  = new iScroll("page2_popup_scroll");
	...
	/* page1 popup start */
		$('.Livingapp').bind('tap', function() {
			$("#page1_popup").show();
			$("#global_pops").addClass("noLink");		
		});
	
		$('#page1_popup_close').bind('tap', function() {
			$("#page1_popup").hide();
	...
	/* page2 popup start */
		...
		$('#page2_popup_close').bind('tap', function() {
			$("#page2_popup").hide();
			$("#global_pops").removeClass("noLink");
		});
