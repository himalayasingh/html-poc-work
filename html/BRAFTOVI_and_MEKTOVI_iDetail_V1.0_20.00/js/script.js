...
$(document).ready(function() {
	...
	testScroll1  = new iScroll("page2_scroll");
	...
	/* Linking Starts */
		...
		$('.link30_00,.slide4,.pfs_btn,.link30_00_title').bind('tap', function() { //alert();
			com.veeva.clm.gotoSlide("BRAFTOVI_and_MEKTOVI_iDetail_V1.0_30.00.zip");	
		});
		$('.link30_10,.os_btn').bind('tap', function() { //alert();
			localStorage.tab = 1;
			com.veeva.clm.gotoSlide("BRAFTOVI_and_MEKTOVI_iDetail_V1.0_30.00.zip");	
		});
		$('.link30_20,.orr_btn').bind('tap', function() {
			localStorage.tab = 2;
			com.veeva.clm.gotoSlide("BRAFTOVI_and_MEKTOVI_iDetail_V1.0_30.00.zip");	
		});
		$('.link30_30,.dor_btn').bind('tap', function() {
			localStorage.tab = 3;
			com.veeva.clm.gotoSlide("BRAFTOVI_and_MEKTOVI_iDetail_V1.0_30.00.zip");	
		});
